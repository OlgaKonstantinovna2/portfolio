export const VKIcon = ({ size = 24, className = "" }: { size?: number; className?: string }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={className}
  >
    <path d="M15.07 8.93V6.6a1.4 1.4 0 0 0-1.4-1.4H10.33a1.4 1.4 0 0 0-1.4 1.4v2.33a1.4 1.4 0 0 0 1.4 1.4h3.34a1.4 1.4 0 0 0 1.4-1.4zm-4.74 0V6.6a.7.7 0 0 1 .7-.7h3.34a.7.7 0 0 1 .7.7v2.33a.7.7 0 0 1-.7.7H11.03a.7.7 0 0 1-.7-.7z"/>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.5 15.5h-3v-7h3v7zm1.5 0v-7h3v7h-3z"/>
  </svg>
);
